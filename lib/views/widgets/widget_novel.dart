...
class WidgetNovel extends StatefulWidget {
  const WidgetNovel({ Key key }) : super(key: key);

  @override
  WidgetNovelState createState() => new WidgetNovelState();
}
            ...
            child: new Column(
              ...
              children: <Widget>[
                new Padding(
                  ...
                  child: _bookItems(context, orientation, bookList['novel'], tabType, 'novel'),
                ),
              ],
            ),
          ) : new Container(),
          ...
          child: new GridTile(
            child: new Material(
              ...
              child: new GestureDetector(
                onTap: () => Navigator.of(context).pushNamed('/detail~novel/' + JSON.encode(info['entry'])),
