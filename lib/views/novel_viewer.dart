...
class NovelViewerState extends State<NovelViewer> {
  ...
  initState() {
    ...
    repeater = new Timer.periodic(new Duration(seconds: 23), (timer) {
      _battery.batteryLevel.then((int val) =>
          setState(() => batteryLevel = val));
      setState(() => now = new DateTime.now().toLocal());
    });
    setState(() => readingProgress = widget.chapterInfo['progress']);
    new Timer(new Duration(seconds: 3), () =>
        scrollTo(_scrollController.position.maxScrollExtent * readingProgress /
            100));
  }
  @override
  dispose() {
  ...
  _getChapterContent() async {
    ...
    List result = await parser.getChapterContent(
        bookParser, widget.chapterInfo['bid'], widget.chapterInfo['cid'],
        widget.chapterInfo['vid']);
  ...
  scrollTo(double offset) {
    _scrollController.animateTo(
        offset, duration: new Duration(seconds: 1), curve: Curves.ease);
  }
    ...
    return new CustomMultiChildLayout(
      ...
      children: <Widget>[
        new LayoutId(
            ...
            child: new Container(color: Theme
                .of(context)
                .cardColor)
        ),
        new LayoutId(
              ...
              children: <Widget>[
                        ...
                        child: new Row(
                          ...
                          children: <Widget>[
                            new Container(
                              ...
                              child: new Text(
                                now != null ? new DateFormat("HH:mm").format(
                                    now) : '',
                                overflow: TextOverflow.ellipsis,
                                style: new TextStyle(
                                    color: Colors.white, fontSize: 12.0),
                            ...
                            new Container(
                              ...
                              child: new Transform.rotate(
                                angle: 4.7,
                                child: new Icon(batteryLevelIcon(), size: 18.0,
                                    color: Colors.white),
                              ),
                            ),
                            new Container(
                ...
                new Expanded(
                  child: new NotificationListener(
                      onNotification: (_) {
                        if (content != null) {
                          double maxRange = _scrollController.position
                              .maxScrollExtent;
                          int progress = ((_scrollController.offset /
                              maxRange) * 100).ceil();
                          setState(() =>
                          readingProgress = (progress == 0 ? 1 : progress));
                        }
                      },
...
//                      physics: const AlwaysScrollableScrollPhysics(),
                            ...
                            child: new ConstrainedBox(
                              constraints: (orientation == Orientation.portrait)
                                  ? const BoxConstraints(minHeight: 850.0)
                                  : const BoxConstraints(minHeight: 550.0),
                              child: new Material(
                  ...
                  child: new Row(
                    children: <Widget>[
                      new Container(
                        ...
                        child: new Text(content != null
                            ? widget.chapterInfo['volume_title']
                            : '',
                          overflow: TextOverflow.ellipsis,
                          style: new TextStyle(
                              color: Colors.white, fontSize: 12.0),
                      ...
                      new Expanded(
                          child: new Align(
                            ...
                            child: new Padding(
                              ...
                              child: new Text(content != null ? widget
